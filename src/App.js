...
import Howtech from './elements/howtech/Howtech';
        ...
        <Router>
            <PageScrollTop>
                <Switch>
                    ...
                    <Route path={`${process.env.PUBLIC_URL + "/home"}`} exact component={DigitalAgency}/>
                    ...
                    <Route path={`${process.env.PUBLIC_URL + "/howtech"}`} exact component={Howtech}/>
